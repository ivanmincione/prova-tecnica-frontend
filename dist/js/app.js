...
__webpack_require__(/*! ./hero-slider */ "./src/js/hero-slider.js");
...
$(function () {
  // find all slides
  var slides = $('.main-slide'); // starting index

  var i = 0; // click listener

  $('#main-slider-next').click(function () {
    // find next index
    // i + 1 or 0 if end of slides
    i = ++i % slides.length; // scroll to that index
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkprova_tecnica_frontend"] = self["webpackChunkprova_tecnica_frontend"] || [];
